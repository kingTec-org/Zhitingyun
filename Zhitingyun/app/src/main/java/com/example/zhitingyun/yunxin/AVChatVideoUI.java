...
public class AVChatVideoUI implements View.OnClickListener {
    ...
    View buttonView, videoRoot, audioRoot, waittingView;
...
//    private int bottomRootHeight = 0;
    ...
    private void findAudioViews() {
        ...
        ImageView imgPatient0 = audioRoot.findViewById(R.id.imgPatient0);
        ImageView imgEquipment0 = audioRoot.findViewById(R.id.imgEquipment0);
        ImageView imgVideo = audioRoot.findViewById(R.id.imgVideo);
        QMUIRoundButton btOver = audioRoot.findViewById(R.id.btAudioOver);
        QMUIRoundButton btcancle0=audioRoot.findViewById( R.id.btncancle0);
        btcancle0.setOnClickListener( this );
        imgPatient0.setOnClickListener(this);
        imgEquipment0.setOnClickListener(this);
        imgVideo.setOnClickListener(this);
        btOver.setOnClickListener(this);
    }
    ...
    private void findVideoViews() {
        ...
        ImageView imgPatient = videoRoot.findViewById(R.id.imgPatient);
        ImageView imgEquipment = videoRoot.findViewById(R.id.imgEquipment);
        ImageView imgSpeech = videoRoot.findViewById(R.id.imgSpeech);
        QMUIRoundButton btOver = videoRoot.findViewById(R.id.btOver);
        QMUIRoundButton btncancle=videoRoot.findViewById( R.id.btncancle );
        btncancle.setOnClickListener( this );
        imgPatient.setOnClickListener(this);
        imgEquipment.setOnClickListener(this);
...
//                initLargeSurfaceView("18258139327");
        ...
        subscription = Observable.interval(0, 1, TimeUnit.SECONDS)
                ...
                .subscribe(new Subscriber<Long>() {
                    ...
                    public void onNext(Long aLong) {
                        tvTime.setText(String.format("%02d", (aLong / 60)) + ":" + String.format("%02d", (aLong % 60)));
                        if (aLong < 30) {
                            btCancel.setVisibility(View.GONE);
                        } else
    ...
    private void initBeWaittingView() {
        ...
        final QMUIRoundButton btAccept = waittingView.findViewById(R.id.btAccept);
        final QMUIRoundButton btRefuse = waittingView.findViewById(R.id.btRefuse);
...
//        }
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.btOver) {
            onFunctionClickListener.onTreatmentOver();
//            doHangUp();
//            if (mIsInComingCall)
//                EventBus.getDefault().post(new MessageEvent(0));
        } else if (i == R.id.btAudioOver) {
            onFunctionClickListener.onTreatmentOver();
//            doHangUp();
//            if (mIsInComingCall)
//                EventBus.getDefault().post(new MessageEvent(0));
        ...
        } else if (i == R.id.btInfo) {
            onFunctionClickListener.onBtPatientClick();

        } else if (i == R.id.imgPatient) {
            onFunctionClickListener.onImgPatientClick();

        }else if(i==R.id.btncancle){
            doHangUp();
        }else if(i==R.id.btncancle0){
            doHangUp();
        }else if (i == R.id.imgPatient0) {
            onFunctionClickListener.onImgPatient0Click();

        } else if (i == R.id.imgEquipment) {
            onFunctionClickListener.onImgEquipClick();

        } else if (i == R.id.imgEquipment0) {
            onFunctionClickListener.onImgEquip0Click();

        } else if (i == R.id.btCancel) {
            if (subscription != null)
                subscription.unsubscribe();
            doHangUp();
            onFunctionClickListener.onCancelClick();
//            doHangUp();
        } else if (i == R.id.btAccept) {
            avChatController.receiveAudioToVideo(avSwitchListener);


//            doHangUp();
        } else if (i == R.id.btRefuse) {
            onAudioToVideoAgree();
