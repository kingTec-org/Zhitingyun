...
public class IndoorHistoryController extends MainController {
...
//                mChart.getXAxis().setAxisMaximum((float) hezArrray.length);
    ...
    public IndoorHistoryController(@NonNull Context context, int from, EquipmentParamater equipmentParamater) {
        super(context);
        this.from = from;
        this.equipmentParamater = equipmentParamater;

        View view = LayoutInflater.from(context).inflate(R.layout.controller_history_indoor, this);
