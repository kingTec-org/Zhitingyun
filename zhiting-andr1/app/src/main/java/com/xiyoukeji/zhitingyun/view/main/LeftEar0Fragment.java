...
public class LeftEar0Fragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener {
    @BindView(R.id.hz125)
    SeekBar sb125;
    @BindView(R.id.hz250)
    SeekBar sb250;
    ...
    public LeftEar0Fragment(Slide0Fragment.OnFeedBackListener onFeedBackListener) {
