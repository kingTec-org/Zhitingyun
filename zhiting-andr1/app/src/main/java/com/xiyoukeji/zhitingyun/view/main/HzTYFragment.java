...
public class HzTYFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_hezity;
    }

    public HzTYFragment(AutoRegulationActivity.OngetInfo ongetInfo) {
