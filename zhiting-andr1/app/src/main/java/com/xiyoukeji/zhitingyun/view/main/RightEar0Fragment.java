...
public class RightEar0Fragment extends BaseFragment {
    ...
    private Slide0Fragment.OnFeedBackListener onFeedBackListener;
    List<Integer> list = new ArrayList<>();


    public RightEar0Fragment(Slide0Fragment.OnFeedBackListener onFeedBackListener) {
        this.onFeedBackListener = onFeedBackListener;
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_slidetest_right;
    }
    ...
    private void prepareHearingTest() {
        pureToneManager = new PureToneManager(this.mContext);
    ...
    protected void initView(View view) {
        ...
        sb125.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private int getPureToneDb(int side) {
                if (side == SideSelect.S_UNILATERAL_RIGHT) {
...
//                show125.setText(String.valueOf(sb125.getProgress()));
                ...
                onFeedBackListener.onFeedback(1, list);
//                show125.setText( String.valueOf( left_hl[1] ) );
