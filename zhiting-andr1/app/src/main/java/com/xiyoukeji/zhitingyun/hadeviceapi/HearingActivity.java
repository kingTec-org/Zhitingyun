...
//    }
        ...
        deviceInfoAdapter.setOnDeviceClickListener(new DeviceInfoAdapter.OnDeviceClickListener() {
            ...
            public void onChoice(int position) {
                ...
                if (deviceManager.getDeviceState(deviceInfo) == null) {
                    ...
                    Toast.makeText(HearingActivity.this, getString(R.string.connecting), Toast.LENGTH_SHORT).show();
                } else {
                    if (deviceManager.disconnectDevice(deviceInfo) == ErrorType.SUCCESS)
                        Toast.makeText(HearingActivity.this, getString(R.string.disconnecting), Toast.LENGTH_SHORT).show();
                    else {
                        disconnectProcess();
                    }
                }
    ...
    private void prepareHearingTest() {
        pureToneManager = new PureToneManager(HearingActivity.this);
    ...
    private void deviceManagerInit() {
        ...
        detectCallback = new DetectCallback() {
            ...
            public void onFail(int error) {
                if (btn_scan.getText().equals(getString(R.string.scanning)))
                    btn_scan.setText(getString(R.string.start_scan));
                Toast.makeText(HearingActivity.this, "detect fail:" + getErrorString(error), Toast.LENGTH_LONG).show();
            }
        };
        ...
        connectCallback = new ConnectCallback() {
            ...
            public void onConnectSuccess() {
                ...
                Toast.makeText(
                        HearingActivity.this, curState.getDevName(), Toast.LENGTH_LONG).show();
            }

            @Override
            public void onDisconnect(boolean active) {
                disconnectProcess();
                Toast.makeText(HearingActivity.this, active? R.string.active_disconnected:
                        R.string.passive_disconnected, Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFail(int error) {
                Toast.makeText(HearingActivity.this, "connect fail:"+ getErrorString(error), Toast.LENGTH_SHORT).show();
            }
        };
        ...
        configCallback = new ConfigCallback() {
            ...
            public void onSuccess(int op) {
                Toast.makeText(HearingActivity.this,getOperationString(op)+" success", Toast.LENGTH_SHORT).show();
                switch(op) {
...
//                        sysParameterList = deviceManager.getSysParameterList();
            ...
            public void onFail(int op, int error) {
                Toast.makeText(HearingActivity.this,getOperationString(op)+getErrorString(error), Toast.LENGTH_SHORT).show();
                switch(op) {
                    case OperationType.OP_AUTO_CHECK:
        ...
        switch (v.getId()) {
            case R.id.btn_scan:
                if (btn_scan.getText().equals(getString(R.string.start_scan))) {
                    ...
                    Toast.makeText(HearingActivity.this, getString(R.string.start_scan), Toast.LENGTH_SHORT).show();
                } else if (btn_scan.getText().equals(getString(R.string.scanning))) {
                    Toast.makeText(HearingActivity.this, getString(R.string.scanning), Toast.LENGTH_SHORT).show();
                }
                break;

            case R.id.btn_set_mem:
                if (et_mem_choice.getText().toString().equals("")) {
                    Toast.makeText(HearingActivity.this, getString(R.string.no_mem_num), Toast.LENGTH_SHORT).show();
                    return;
                }
