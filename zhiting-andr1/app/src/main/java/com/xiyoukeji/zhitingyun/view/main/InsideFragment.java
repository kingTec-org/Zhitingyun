...
import com.xiyoukeji.zhitingyun.data.entity.SystermParamater;
...
import static com.xiyoukeji.zhitingyun.R2.attr.duration;
...
public class InsideFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_volumbar;
    }


    public InsideFragment(AutoRegulationActivity.OngetInfo ongetInfo) {
    ...
    public void insideList(List sysParameterList){
    ...
    public void fillAllParameterList(List<HAParameterList> sysParameterList, List<HAParameterList> memParameterList, final int currentMemory ) {
        ...
        this.memParameterList = memParameterList;
        ...
        if (ZhitingyunApplication.curState.getHaSide() == SideSelect.S_BINAURAL) {
            ...
            for (final HAParameter parameter : memParameterList.get(SideSelect.S_UNILATERAL_LEFT).getParameterList()) {
                ...
                entity.setL_P_CHMPO(q1 + "," + q2 + "," + q3 + "," + q4 + "," + q5);
