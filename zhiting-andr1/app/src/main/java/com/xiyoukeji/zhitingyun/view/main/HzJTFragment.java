...
public class HzJTFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_hezijt;
    }

    public HzJTFragment(AutoRegulationActivity.OngetInfo ongetInfo) {
