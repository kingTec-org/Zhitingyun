...
public class SPUtil {
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(Utils.getContext(), PreferenceName, key, t);
    }
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(Utils.getContext(), PreferenceName, key);
    }
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = Utils.getContext().getSharedPreferences(PreferenceName,
