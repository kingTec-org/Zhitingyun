...
public class Damage0Activity extends BaseActivity {
    @BindView( R.id.tab )
    XTabLayout tab;
    @BindView( R.id.vp )
    ViewPager vp;
    ...
    protected void initView(){
        ...
        fragmentList.add( Slide0Fragment.newInstance() );
        fragmentList.add( Input0Fragment.newInstance() );
