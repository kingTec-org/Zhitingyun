...
public class InsideJTFragment extends BaseFragment {
    @BindView(R.id.left)
    SeekBar mLeftSb;
    @BindView(R.id.right)
    SeekBar mRightSb;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_volumbarjt;
    }


    public InsideJTFragment(AutoRegulationActivity.OngetInfo ongetInfo) {
