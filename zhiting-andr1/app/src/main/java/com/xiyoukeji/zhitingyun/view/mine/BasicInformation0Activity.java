...
public class BasicInformation0Activity extends BaseActivity {
    ...
    public BasicInformation0Activity() {
            ...
            case R.id.btn_submit:
                mViewModel.completeInfo( mName, mSex, mAge, mWearTimeEnum,headpic, new BaseObserver<Model0<UserEntity>>() {
                    ...
                    public void onNext(Model0<UserEntity> userEntityModel0) {
                        ...
                        Intent intent = new Intent(BasicInformation0Activity.this,MainActivity.class);
    ...
    private void initDialog() {
        ...
        datePicker.init( cyear, cmonth - 1, cday, new DatePicker.OnDateChangedListener() {
            public void onDateChanged(DatePicker datePicker, int i, int i1, int i2) {
                setTitle( i + "-" + (i1 + 1) + "-" + i2 + "-" );
                BasicInformation0Activity.this.year = i;
                BasicInformation0Activity.this.month = i1;
                BasicInformation0Activity.this.day = i2;
                // 显示当前时间
...
//                mViewModel.mUrl.set( images.get( 0 ).path );
...
//                SharedPreferences sharedPreferences = getSharedPreferences("mySP", Context.MODE_PRIVATE);
//                SharedPreferences.Editor editor = sharedPreferences.edit();
//                editor.putString("headpic", stringModel0.getComeback());
//                editor.commit();
            }
