...
public class HzHWFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_hezihw;
    }

    public HzHWFragment(AutoRegulationActivity.OngetInfo ongetInfo) {
